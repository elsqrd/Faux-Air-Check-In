...
import './App.css';
import SelectResDoneScreen from './SelectResDoneScreen.js';
import SelectReservationScreen from './SelectReservationScreen.js';
import ConditionsScreen from './ConditionsScreen.js';
    ...
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        default:
          return null;
        case 'selectresdone':
          return (<SelectResDoneScreen {...screenProps} />)
        case 'selectreservation':
          return (<SelectReservationScreen {...screenProps} />)
        case 'conditions':
          return (<ConditionsScreen {...screenProps} />)
        case 'welcome':
